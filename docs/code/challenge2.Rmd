...
Now let's try to scrape the text from the first campaign speech. Here's a [direct link](http://www.presidency.ucsb.edu/ws/index.php?pid=96348) to it, but in a second we'll try to generalize this step.Extract the title of the speech.
