...
Let's assume we want to see the results of the state of Distrito Capital for the GPP party. First, let's use selectorGated to identify the elements that we're trying to scrape. Then, click on the list of states and parties to find the exact state and party you would want to scrape.
