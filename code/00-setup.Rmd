...
toInstall <- c("ROAuth", "ggplot2", "stringr",
	"devtools", "quanteda", "igraph", "httr", 
	"glmnet", "doMC", "rvest", "rJava", "boilerpipeR", "RJSONIO",
	"tabulizer", "reshape")
...
if (doInstall) devtools::install_github("ropensci/RSelenium")
```
